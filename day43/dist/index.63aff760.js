...
var _styleScss = require("./assets/scss/style.scss");
var _header = require("./components/Header");
var _footer = require("./components/Footer");
var _backgroundPng = require("./assets/img/background.png");
...
const { SERVER_API } = (0, _configJsonDefault.default);
const App = ()=>{
    return `
  ${(0, _header.Header)()}
  <h1>App</h1>
  <img src="${0, _backgroundPngDefault.default}" alt="" width="50%">
  ${(0, _footer.Footer)()}
  </p>${SERVER_API}</p>
  <h2>${(0, _momentDefault.default)().format("LLLL")}</h2>
  `;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/Header":"hsJbF","./components/Footer":"8pPOA","./assets/scss/style.scss":"bQ6jc","./assets/img/background.png":"4CNPy","./config.json":"8VeYg","moment":"jwcsj"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bQ6jc":[function() {},{}],"4CNPy":[function(require,module,exports) {
module.exports = require("487aece55a61879e").getBundleURL("3gKDs") + "background.0c55243b.png" + "?" + Date.now();

},{"487aece55a61879e":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
module.exports = JSON.parse('{"SERVER_API":"https://api.escuelajs.co/api/v1","WEBSITE":"https://escuelajs.co"}');
...
},{}]},["6DoTH","adjPd"], "adjPd", "parcelRequire8125")
